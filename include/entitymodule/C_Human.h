...
public:
    ...
    // Native equivalents of C_ScriptBindHuman DrawWeapon/HolsterWeapon/
    // IsWeaponDrawn. These dispatch through the Human's verified controller
    // getter at actor vtable slot 191 and never enter the script system.
    bool SetWeaponDrawn(bool drawn);
